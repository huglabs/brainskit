...
from brainkit.application.jobs import Jobs
...
from brainkit.application.projections import DEFAULT_EXPORT_CONSUMER, Projections
from brainkit.application.reader import Reader
...
class BrainkitService:
    ...
    def graph_data(self, *, consumer: str = "human") -> dict[str, Any]:
        """The graph, filtered for a consumer. See `Projections`."""
